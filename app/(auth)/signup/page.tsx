      ...
      <section className="w-full max-w-md space-y-8">
        <header className="text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {step === 1
              ? "Get started with your budget tracker"
              : "Step 2: Personalize your experience"}
          </p>
        </header>

        {/* Google OAuth Sign Up - only show on step 1 */}
        {step === 1 && (
          <>
            <button
              onClick={handleGoogleSignup}
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-border px-4 py-2.5 text-sm font-medium hover:bg-secondary transition-colors"
            >
